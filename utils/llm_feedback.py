...
# def get_feedback(transcription: str, question: str) -> Dict[str, Any]:
#     system_prompt = """
# You are an AI interview coach. Analyze the candidate's answer to the given question.
...
#   },
#   "feedback": "<Concise and helpful feedback>"
# }
# """
